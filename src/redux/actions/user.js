...
export const login = (email, password) => async (dispatch) =>{
    ...
    try {
        ...
        const {data} = await axios.post(`${server}/login`, {email, password}, {headers:{'Content-Type': 'application/json'},withCredentials:true})
...
export const loadUser = () => async (dispatch) =>{ //get My profile
...
export const register = (formdata) => async (dispatch) =>{
    ...
    try {
        ...
        const {data} = await axios.post(`${server}/register`, formdata, {headers:{'Content-Type': 'multipart/form-data'},withCredentials:true})
