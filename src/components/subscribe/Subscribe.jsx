...
const Subscribe = ({user}) => {
  ...
  return (
    <Container h={'90vh'} p={16}>
        ...
        <Box bg="yellow.400" p={4} css={{borderRadius: '8 8 0 0'}} ><Text color={"black"} children={'Pro Pack - $299.00'} /></Box>  
        <Box p={4} >
            <VStack textAlign={'center'} px="8" mt={4} spacing={8}>

                <Text children={"Join pro pack and get access to all content."}  />            
                <Heading size={"md"} children={'$299 Only'} /></VStack>
                <Button my={8} w={"full"} colorScheme={"yellow"} onClick={subscribeHandler} isLoading={loading} >Subscribe</Button>
                </Box>     
                <Box bg={"blackAlpha.600"} p={4} css={{borderRadius: '0 0 8 8'}}>
